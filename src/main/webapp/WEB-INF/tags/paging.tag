...
<script
	src="${pageContext.request.contextPath}/resources/dist/css/jquery.min.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/dist/css/bootstrap.min.js"></script>
